export default class SUPERMissionCard extends HTMLElement {
	
	static get observedAttributes (){
		return ["card-id", "card-type", "card-name", "card-description", "card-color"];
	};
            ...
            <style>
            	*{
                ...
                #cardComponent {
				    ...
				    perspective: 700px;
				    padding: 4px;
				    background-color: var(--card-type-Mission, #fff);
				    border-radius: 18px;
				}
