        ...
        let missionCardHTML = `
            <style>
                ...
                .card.who-is-assessed {
                    ...
                    border: 7px solid var(--who-is-assessed-border-color);
                }

                .card.the-assessor {
                    background-color: var(--the-assessor-color);
                    border: 7px solid var(--the-assessor-border-color);
                }

                .card.assessment-artefact {
                    background-color: var(--assessment-artefact-color);
                    border: 7px solid var(--assessment-artefact-border-color);
                }

                .card.assessment-format {
                    background-color: var(--assessment-format-color);
                    border: 7px solid var(--assessment-format-border-color);
                }

                .card.context {
                    background-color: var(--context-color);
                    border: 7px solid var(--context-border-color);
                }

                .card.assessment-timing {
                    background-color: var(--assessment-timing-color);
                    border: 7px solid var(--assessment-timing-border-color);
                }
