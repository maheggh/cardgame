class SuperAssessmentCard extends HTMLElement {
    ...
    connectedCallback() {
        ...
        document.addEventListener('disableInteractions', this.disableInteractions);
        document.addEventListener('enableInteractions', this.enableInteractions);
    }

    disconnectedCallback() {
        document.removeEventListener('disableInteractions', this.disableInteractions);
        document.removeEventListener('enableInteractions', this.enableInteractions);
    }
